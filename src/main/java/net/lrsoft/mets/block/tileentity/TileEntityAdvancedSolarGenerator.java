...
public class TileEntityAdvancedSolarGenerator extends TileEntityBaseGenerator {
	private int ticker;
	private static final int tickRate = 128;
	private static final double energyMultiplier = 64d * ConfigUtil.getDouble(MainConfig.get(), "balance/energy/generator/solar");
	@GuiSynced
