...
public enum MetsBlockWithTileEntity implements ITeBlock {
	...
	laser_tower((Class)TileEntiyLaserTower.class, 42, true, Util.horizontalFacings, true, HarvestTool.Wrench, DefaultDrop.Machine, 2.0F, 10.0F, EnumRarity.COMMON, IC2Material.MACHINE, false),
	advanced_laser_tower((Class)TileEntityAdvancedLaserTower.class, 43, true, Util.horizontalFacings, true, HarvestTool.Wrench, DefaultDrop.Machine, 2.0F, 10.0F, EnumRarity.COMMON, IC2Material.MACHINE, false);
