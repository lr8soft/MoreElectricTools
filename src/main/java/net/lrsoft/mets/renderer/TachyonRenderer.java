...
public class TachyonRenderer <T extends EntityTachyonBullet> extends Render<T>{
	private final ResourceLocation texture;
	public TachyonRenderer(RenderManager manager, ResourceLocation texture)
	{
		super(manager);
	...
	public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		float alpha = (float)entity.getCanAttackTimes() / 3.0f;
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTachyonBullet entity)
	{
		return texture;
	}
