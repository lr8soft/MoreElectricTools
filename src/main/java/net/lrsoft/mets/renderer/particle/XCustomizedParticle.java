...
public class XCustomizedParticle {
	...
	public void onRender(float partialTicks, float alpha)
	{
		if(currentTicks < maxTicks)
		{
	        ...
	        bufferbuilder.pos(-0.5D, -0.25D, 0.0D).tex(0.0d, 0.0d).color(red, green, blue, alpha).normal(0.0F, 1.0F, 0.0F).endVertex();
	        bufferbuilder.pos(0.5D, -0.25D, 0.0D).tex(1.0d, 0.0d).color(red, green, blue, alpha).normal(0.0F, 1.0F, 0.0F).endVertex();
	        bufferbuilder.pos(0.5D, 0.75D, 0.0D).tex(1.0d, 1.0d).color(red, green, blue, alpha).normal(0.0F, 1.0F, 0.0F).endVertex();
	        bufferbuilder.pos(-0.5D, 0.75D, 0.0D).tex(0.0d, 1.0d).color(red, green, blue, alpha).normal(0.0F, 1.0F, 0.0F).endVertex();
	        tessellator.draw();
