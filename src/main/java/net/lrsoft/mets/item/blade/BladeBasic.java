...
/////////////////////////////////////////////////////////////////////////////////////////////
          ItemStack custombladeReqired = new ItemStack(SlashBlade.weapon);//Da Tai Dao
	      ...
	      SlashBlade.addRecipe(name, new RecipeAwakeBlade(new ResourceLocation(SlashBlade.modid,name), trfirst_need, custombladeReqired, 
	    		  new Object[]{"XAX",
	    		               "XBX",
	    		               "CAC",
	        	  Character.valueOf('X'), Items.IRON_INGOT,
	    		  Character.valueOf('A'), Items.BLAZE_ROD,
