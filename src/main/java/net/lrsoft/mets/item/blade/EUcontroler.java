...
public class EUcontroler  extends ItemSlashBladeNamed implements IElectricItem, IItemHudInfo {
		private static int maxEnergy = 3000000;//3000000
		private static int maxTransfer = 8192;
	   
	   NBTTagCompound tag = new NBTTagCompound();
	    public EUcontroler(ToolMaterial par2EnumToolMaterial, float baseAttackModifiers) {
	    ...
	    public void onUpdate(ItemStack sitem, World par2World, Entity par3Entity, int indexOfMainSlot, boolean isCurrent) {
	        ...
	        if (!par2World.isRemote) {
	        	...
	        	if((int)ElectricItem.manager.getCharge(sitem)>=2900000){
