...
public class EUbasic extends ItemSlashBladeNamed implements IElectricItem, IItemHudInfo{
	private static int maxEnergy = 100000;
	private static int maxTransfer = 1024;
	
	public EUbasic(ToolMaterial par2EnumToolMaterial, float baseAttackModifiers) {
    ...
    public void onUpdate(ItemStack sitem, World par2World, Entity par3Entity, int indexOfMainSlot, boolean isCurrent) {
        ...
        if (!par2World.isRemote) {
        	...
        	if((int)ElectricItem.manager.getCharge(sitem)>=99000){
