...
public class EntityKineitcImpact extends Entity implements IThrowableEntity {
    ...
    public EntityKineitcImpact(World par1World)
    {
        super(par1World);
        ticksExisted = 0;
    }
    ...
    private static final DataParameter<Integer> ThrowerEntityID = EntityDataManager.<Integer>createKey(EntityKineitcImpact.class, DataSerializers.VARINT);
    ...
    public EntityKineitcImpact(World par1World, EntityLivingBase entityLiving)
    {
        this(par1World);
