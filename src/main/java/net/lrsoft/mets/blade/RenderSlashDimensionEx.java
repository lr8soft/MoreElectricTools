...
//Modify from https://github.com/flammpfeil/SlashBlade/blob/1.12.2/src/main/java/mods/flammpfeil/slashblade/client/renderer/entity/RenderSlashDimension.java
//Original author flammpfeil
public class RenderSlashDimensionEx extends Render {
	public static float ModelScaleSize = 0.035f;
    ...
    public RenderSlashDimensionEx(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    public void renderModel(Entity entity, double x, double y, double z, float yaw, float partialRenderTick) {
        ...
        GL11.glScalef(ModelScaleSize,ModelScaleSize, ModelScaleSize);
