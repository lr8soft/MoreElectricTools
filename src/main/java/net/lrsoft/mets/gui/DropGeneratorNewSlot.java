...
import net.lrsoft.mets.block.tileentity.TileEntityDropGeneratorNew;
import net.lrsoft.mets.util.DropGeneratorInfo;
import net.minecraft.item.Item;
import net.minecraft.item.ItemStack;

public class DropGeneratorNewSlot extends InvSlotConsumable {
	public DropGeneratorNewSlot(IInventorySlotHolder<?> base1, String name1, int count) {
		 super((TileEntityInventory)base1, name1, InvSlot.Access.I, count, InvSlot.InvSide.SIDE);
	}
